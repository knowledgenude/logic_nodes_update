...
class OnVolumeTriggerNode extends LogicNode {
	...
	function update() {
		...
		var overlap = l1.x + d1.x / 2.0 > l2.x - d2.x / 2.0 && l1.x - d1.x / 2.0 < l2.x + d2.x / 2.0 &&
				  	  l1.y + d1.y / 2.0 > l2.y - d2.y / 2.0 && l1.y - d1.y / 2.0 < l2.y + d2.y / 2.0 &&
				  	  l1.z + d1.z / 2.0 > l2.z - d2.z / 2.0 && l1.z - d1.z / 2.0 < l2.z + d2.z / 2.0;
